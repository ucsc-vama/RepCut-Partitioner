...
> **Provenance note (RepCut vendored copy):** These files are vendored from
> <https://gitlab.com/eidheim/tiny-process-library> (MIT license) and compiled
> directly into `librepcut`.  See `LICENSE` in this directory.  Upstream
> changes are not tracked automatically — sync manually if needed.
